...
const queueItems = [
  { label: 'Instagram Clone', value: '12 posts mapped', tone: 'bg-sky-400/12 text-sky-300 border-sky-400/20' },
  { label: 'WaveSpeed Video', value: '3 reels rendering', tone: 'bg-violet-400/12 text-violet-300 border-violet-400/20' },
    ...
    <section className="mx-auto w-full max-w-6xl overflow-hidden px-4 pb-20 pt-10 sm:px-6 lg:pt-16">
      ...
      <div className="relative z-10 grid items-center gap-14 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)]">
        <div className="flex max-w-2xl flex-col gap-5">
          ...
          >
            <div className="rounded-full border border-sky-300/20 bg-sky-400/10 px-2.5 py-1 shadow-sm">
              <p className="font-mono text-[11px] uppercase tracking-[0.22em] text-sky-300">Beta</p>
            </div>
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="absolute inset-x-0 -top-10 mx-auto h-56 w-56 rounded-full bg-sky-400/10 blur-[90px]" />
                    ...
                    <div className="mt-4 space-y-3">
                      {queueItems.map((item) => (
                        ...
                        >
                          ...
                          <span className={cn('rounded-full border px-2.5 py-1 text-[11px]', item.tone)}>Live</span>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="mt-4 aspect-[4/5] rounded-[20px] border border-white/10 bg-[radial-gradient(circle_at_top,rgba(56,189,248,0.18),transparent_28%),linear-gradient(180deg,#111827_0%,#0b0f16_100%)] p-3">
                    <div className="flex h-full flex-col justify-between rounded-[16px] border border-white/8 bg-black/20 p-3">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="rounded-full border border-violet-400/20 bg-violet-400/10 px-2.5 py-1 text-[11px] text-violet-300">
                          Veo / WaveSpeed
                        </span>
                      </div>
