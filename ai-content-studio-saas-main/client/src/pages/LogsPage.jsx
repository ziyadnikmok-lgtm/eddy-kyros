          ...
          {loading && !lines.length ? (
            ...
            <div className="max-h-[70vh] overflow-auto">
              <div className="min-w-[760px]">
                <div className="grid grid-cols-[170px_90px_1fr] gap-3 border-b border-zinc-800/70 bg-zinc-900/70 px-4 py-3 text-[11px] font-semibold uppercase tracking-[0.16em] text-zinc-500">
                  <div>Timestamp</div>
                  <div>Level</div>
                  <div>Message</div>
                </div>
