...
(async () => {
  ...
  const gal = fs.readFileSync(path.join(ROOT, 'server/routes/gallery.js'), 'utf8');
  ...
  const svcSrc = fs.readFileSync(path.join(ROOT, 'server/services/iosSpoofService.js'), 'utf8');
