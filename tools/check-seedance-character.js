...
const vid = fs.readFileSync(path.join(ROOT, 'client/src/pages/SeedanceVideoPage.jsx'), 'utf8');
const omni = fs.readFileSync(path.join(ROOT, 'client/src/pages/SeedanceOmniPage.jsx'), 'utf8');
