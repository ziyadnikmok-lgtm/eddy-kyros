/* pico.js - MIT, https://github.com/nenadmarkus/picojs
 *
 * Vendored rather than installed: 5 KB, no dependencies, and a packaged Electron build has
 * to work offline.
 *
 * Only change from upstream: `pico = {}` becomes `const pico = {}` and an export is added,
 * so it is a module instead of a global.
 */
