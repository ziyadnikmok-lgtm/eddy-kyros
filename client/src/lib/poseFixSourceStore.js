/**
 * Durable source-image storage for Pose Fix (mirrors photoMatchSourceStore).
 * Separate IndexedDB namespace so Pose Fix sources don't collide with Photo Match.
 *
 * Each record: { id, name, type, size, dataUrl }
 */

const DB_NAME = 'kyros-pose-fix';
const STORE = 'sources';
const VERSION = 1;
