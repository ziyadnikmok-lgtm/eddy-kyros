...
function LogEntry({ entry }) {
  ...
  return (
    <div className={`flex gap-2 text-[0.6875rem] font-mono ${color}`}>
    ...
    <div className="space-y-5 animate-in">
      ...
      <Card>
        <div className="space-y-3">
          ...
          />
          {cookieError && (
            <p className="text-[0.6875rem] text-red-400">{cookieError}</p>
          )}
          {cookieParsed && (
            <p className="text-[0.6875rem] text-green-400">
          ...
          <div className="text-[0.625rem] text-zinc-600 space-y-0.5">
      ...
      <Card>
        <div className="space-y-3">
          ...
          <p className="text-[0.6875rem] text-zinc-500">The bot will visit these accounts and reply to their recent posts</p>
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="rounded-xl bg-zinc-800/40 border border-zinc-700/30 p-3 text-center">
          ...
          <p className="text-[0.625rem] text-zinc-500">Max replies per session</p>
        </div>
        <div className="rounded-xl bg-zinc-800/40 border border-zinc-700/30 p-3 text-center">
          <p className="text-lg font-bold text-zinc-200">1 hr</p>
          <p className="text-[0.625rem] text-zinc-500">Max session duration</p>
        </div>
      </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="space-y-1">
                <div className="flex justify-between text-[0.625rem] text-zinc-500">
                  <span>Replies</span>
            ...
            {/* Activity Log */}
            <div>
              <p className="text-[0.625rem] font-medium text-zinc-500 uppercase tracking-wider mb-2">Activity Log</p>
              <div className="h-52 overflow-y-auto rounded-lg bg-zinc-900/60 border border-zinc-800/60 p-3 space-y-1">
                {session.log.length === 0 && (
                  <p className="text-[0.6875rem] text-zinc-600 italic">Waiting for activity...</p>
                )}
