...
const LIFECYCLE_PHASES = [
  ...
  { key: 'sustain', label: 'Sustain', sub: '1-24 hours', color: 'text-rose-400', dot: 'bg-rose-400' },
...
function ScoreBar({ label, value, max = 10, color = 'blue' }) {
  ...
  return (
    <div className="flex items-center gap-2">
      <span className="text-[0.625rem] text-zinc-500 w-28 shrink-0 text-right">{label}</span>
      ...
      <span className="text-[0.625rem] text-zinc-400 font-mono w-8">{value}/{max}</span>
    </div>
  );
}
  ...
  return (
    <div className="flex flex-col items-center gap-1">
      ...
      <div className="absolute flex flex-col items-center justify-center" style={{ width: 88, height: 88 }}>
        ...
        <span className="text-[0.5rem] text-zinc-500 uppercase tracking-wider">/ 100</span>
      </div>
    </div>
  );
}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6">
        <div className="lg:col-span-1 space-y-4">
          <Card className="space-y-4">
            ...
            <label className="inline-flex cursor-pointer items-center rounded-lg border border-dashed border-zinc-700/80 px-3 py-2 text-xs text-zinc-300 hover:border-rose-500/70 hover:text-rose-300 transition">
              <input
                type="file"
          ...
          <Card className="space-y-4">
            ...
            {nicheId === 'custom' && (
              <input
                ...
                className="w-full rounded-lg border border-zinc-700/80 bg-zinc-900/60 px-3 py-2.5 text-sm text-zinc-100 outline-none transition-all duration-200 hover:border-zinc-600 focus:border-rose-500/70 focus:ring-1 focus:ring-rose-500/20"
              />
            )}
              ...
              <div className="grid grid-cols-3 gap-1.5">
                {OPTIMIZE_OPTIONS.map((opt) => (
                  <button
                    ...
                    className={cn(
                      'px-2 py-1.5 rounded-md text-[0.6875rem] font-medium transition cursor-pointer',
          ...
          {!result && !loading ? (
            ...
            <>
                    ...
                    <Card className="animate-in space-y-3">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        {ei.optimizedFor && ei.optimizedFor !== 'general' && (
                          <span className="text-[0.625rem] text-zinc-500">Optimized for {ei.optimizedFor}</span>
                        )}
                      </div>
                      ...
                      {ei.tips?.length > 0 && (
                        <div className="pt-2 border-t border-zinc-800/60">
                          <p className="text-[0.625rem] text-zinc-500 font-medium uppercase tracking-wider mb-1">Tips</p>
                        ...
                        return (
                          <div key={phase.key}>
                            <div className="flex items-center gap-1.5 mb-1">
                              ...
                              <span className="text-[0.625rem] text-zinc-600">{phase.sub}</span>
                            </div>
              ...
              <div className="space-y-4">
                ...
                <Card className="animate-in border-l-4 !border-l-rose-500">
