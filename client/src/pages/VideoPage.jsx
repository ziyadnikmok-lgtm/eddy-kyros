      ...
      <div>
        ...
        <div className="space-y-4">
          ...
          <Card className="space-y-3">
            ...
            {showGallery && (
              <div className="pt-2">
                <p className="mb-2 text-[0.6875rem] text-zinc-500 uppercase tracking-wider">
                      ...
                      <button
                        ...
                        className={`relative aspect-square overflow-hidden rounded-lg border transition-all cursor-pointer hover:scale-[1.03] hover:shadow-[0_0_16px_rgba(59,130,246,0.2)] ${
                          galleryTarget === 'source' && sourceGalleryId === img.id
                            ? 'border-2 border-rose-500 shadow-[0_0_14px_rgba(59,130,246,0.3)]'
          ...
          <Card className="space-y-3">
            ...
            <select
              ...
              className="w-full rounded-lg border border-zinc-700/60 bg-zinc-900/50 px-3 py-2.5 text-sm text-zinc-100 outline-none transition-all duration-200 cursor-pointer inset-depth hover:border-zinc-600 focus:border-rose-500/70 focus:ring-2 focus:ring-rose-500/20"
            >
              {VIDEO_MODELS.map((m) => (
            ...
            {modelInfo.prices && (
              <div className="flex items-center gap-3 text-[0.6875rem] text-zinc-500">
          ...
          <Card className="space-y-3">
            ...
            <textarea
              ...
              rows={3}
              maxLength={2500}
              className="w-full rounded-lg border border-zinc-700/60 bg-zinc-800/60 px-3 py-2 text-sm text-zinc-200 placeholder-zinc-600 inset-depth focus:outline-none focus:ring-2 focus:ring-rose-500/20 resize-y min-h-[72px]"
            />
            <div className="text-[0.625rem] text-zinc-600 text-right">{prompt.length}/2500</div>
          </Card>
          ...
          <Card className="space-y-3">
                    ...
                    {modelInfo.durations.map((d) => (
                      <button key={d} onClick={() => setDuration(d)}
                        className={`flex-1 rounded-md px-2 py-1.5 text-xs font-medium border transition-colors cursor-pointer ${
                          duration === d
                            ? 'border-rose-500/50 bg-rose-600/12 text-rose-400'
            ...
            <Section title="Negative Prompt" hint="Describe what you don't want in the video">
              <textarea
                ...
                rows={2}
                className="w-full rounded-lg border border-zinc-700/60 bg-zinc-800/60 px-3 py-2 text-sm text-zinc-200 placeholder-zinc-600 inset-depth focus:outline-none focus:ring-2 focus:ring-rose-500/20 resize-y"
              />
            </Section>
          </Card>
            ...
            <Card className="space-y-3">
              ...
              {motionSourceType === 'url' ? (
                <input
                  ...
                  className="w-full rounded-lg border border-zinc-700/60 bg-zinc-800/60 px-3 py-2 text-sm text-zinc-200 placeholder-zinc-600 inset-depth focus:outline-none focus:ring-2 focus:ring-rose-500/20"
                />
              ) : (
                <div className="space-y-2">
                  ...
                  <p className="text-[0.625rem] text-zinc-600">MP4, MOV, WebM. Max 120MB.</p>
                </div>
              )}
