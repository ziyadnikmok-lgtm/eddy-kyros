    ...
    <div className="space-y-4 animate-in">
      <Card className="space-y-3">
        ...
        <input
          ...
          className="w-full h-9 rounded-lg border border-zinc-700/80 bg-zinc-900/60 px-3 text-sm text-zinc-200 placeholder:text-zinc-500 outline-none focus:border-rose-500/70 focus:ring-2 focus:ring-rose-500/20"
        />
              ...
              <button
                ...
                className={cn(
                  ...
                  batchMode && isSelected
                    ...
                    : 'border-zinc-700/50 hover:border-rose-500/50',
                )}
              >
                <img
                ...
                {batchMode && (
                  <div className={cn(
                    'absolute top-1.5 left-1.5 w-5 h-5 rounded border-2 flex items-center justify-center text-[0.625rem] transition',
                    isSelected
                ...
                {!batchMode && (
                  <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-1.5">
                    <span className="text-[0.5625rem] text-zinc-300 truncate w-full">{img.source || 'image'}</span>
                  </div>
                )}
              </button>
            );
