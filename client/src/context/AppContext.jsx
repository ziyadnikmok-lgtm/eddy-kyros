...
const VALID_PAGE_IDS = new Set(['generate', 'nsfwGenerate', 'batch', 'auto', 'video', 'videoGallery', 'seedanceVideo', 'seedanceOmni', 'seedreamEdit', 'carousel', 'scene', 'reel', 'postClone', 'pinterest', 'instagramFrames', 'frameLibrary', 'styleLibrary', 'promptBuilder', 'profileAnalyzer', 'storyteller', 'loraDataset', 'library', 'pasteInbox', 'imageEditor', 'characters', 'keys', 'billing', 'referral', 'videoCompose', 'logs', 'photoMatch', 'poseFix', 'nanoBypass', 'outfitSwap', 'seedreamGenerate', 'outfitSwapSeedream', 'photoMatchSeedream', 'pinterestFeed', 'sceneRecreateSeedream', 'poseRemixSeedream', 'eddyGenerate', 'eddy', 'eddyLibrary', 'eddyOutfit', 'eddyPose', 'eddyEnvironment', 'eddyMaxNano', 'eddyMaxOutfit', 'eddyBase', 'eddyBaseLibrary', 'videoLibrary', 'eddyCharacter', 'admin', 'settings', 'instagramReel', 'videoEditor']);
