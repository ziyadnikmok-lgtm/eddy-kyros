...
const VALID_PAGE_IDS = new Set(['generate', 'nsfwGenerate', 'batch', 'auto', 'video', 'videoGallery', 'seedanceVideo', 'seedanceOmni', 'seedreamEdit', 'carousel', 'scene', 'reel', 'postClone', 'pinterest', 'instagramFrames', 'frameLibrary', 'styleLibrary', 'promptBuilder', 'profileAnalyzer', 'storyteller', 'loraDataset', 'gallery', 'library', 'pasteInbox', 'imageEditor', 'characters', 'keys', 'billing', 'referral', 'videoCompose', 'logs', 'photoMatch', 'poseFix', 'nanoBypass', 'outfitSwap', 'outfitSwapSeedream', 'photoMatchSeedream', 'sceneRecreateSeedream', 'poseRemixSeedream', 'eddyGenerate', 'eddy', 'eddyLibrary', 'eddyOutfit', 'eddyPose', 'eddyEnvironment', 'videoLibrary', 'eddyCharacter', 'admin', 'settings']);
