...
const VALID_PAGE_IDS = new Set(['generate', 'batch', 'auto', 'video', 'videoGallery', 'carousel', 'scene', 'reel', 'postClone', 'styleLibrary', 'promptBuilder', 'profileAnalyzer', 'storyteller', 'gallery', 'characters', 'keys']);
