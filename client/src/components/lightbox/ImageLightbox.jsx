    ...
    >
      ...
      <div className="absolute top-4 right-4 z-[2] flex items-center gap-2">
        <button
          ...
          className="rounded-xl border border-white/15 bg-white/10 px-3 py-2 text-sm text-zinc-100 shadow-lg shadow-black/40 backdrop-blur-lg transition hover:border-rose-300/50 hover:bg-white/20 hover:shadow-rose-500/20 cursor-pointer"
        >
          X
        </button>
        <button
          ...
          onClick={async () => {
            ...
            await downloadBlob(blob, `image-${currentIndex + 1}.png`);
          }}
          className="rounded-xl border border-white/15 bg-white/10 px-3 py-2 text-sm text-zinc-100 shadow-lg shadow-black/40 backdrop-blur-lg transition hover:border-rose-300/50 hover:bg-white/20 hover:shadow-rose-500/20 cursor-pointer"
        >
          Download
      ...
      {imageUrls.length > 1 && (
        <>
          <button
            ...
            className="absolute left-4 z-[2] rounded-xl border border-white/15 bg-white/10 px-4 py-3 text-lg text-zinc-100 shadow-lg shadow-black/40 backdrop-blur-lg transition hover:border-rose-300/50 hover:bg-white/20 hover:shadow-rose-500/20 cursor-pointer"
          >
            {'<'}
          </button>
          <button
            ...
            className="absolute right-4 z-[2] rounded-xl border border-white/15 bg-white/10 px-4 py-3 text-lg text-zinc-100 shadow-lg shadow-black/40 backdrop-blur-lg transition hover:border-rose-300/50 hover:bg-white/20 hover:shadow-rose-500/20 cursor-pointer"
          >
            {'>'}
          </button>
        </>
