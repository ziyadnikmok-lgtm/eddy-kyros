...
export default function CompareSlider({
  ...
  return (
    <div
      ...
      className={cn(
        'relative select-none overflow-hidden rounded-xl border border-zinc-700/60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-500/40',
